using AgriculturePresentationProject.Models;
...
namespace AgriculturePresentationProject.Controllers
{
    public class ReportController : Controller
    {
        ...
        public IActionResult StaticReport()
        {
            ...
            return File(bytes, "application/vnd.openxmlformat-officedocument.spreadsheetml.sheet", "BakliyatRaporu.xlsx");
        }
        ...
        public IActionResult AnnouncementReport()
        {
            using (var workBook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    workBook.SaveAs(stream);
                    var content = stream.ToArray();
                    return File(content, "application/vnd.openxmlformat-officedocument.spreadsheetml.sheet", "DuyuruRapor.xlsx");
                }
            }
        }
    }
